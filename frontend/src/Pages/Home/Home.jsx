...
//             <a href="#" className="font-medium">Inventory</a>
//             <a href="#" className="font-medium">Shopping Lists</a>
//             <a href="#" className="font-medium">Reports</a>
//           </div>
//           <div className="flex items-center space-x-2">
//             <button className="bg-blue-600 hover:bg-blue-800 px-3 py-1 rounded">Help</button>
//             <button className="bg-blue-600 hover:bg-blue-800 px-3 py-1 rounded">Settings</button>
//           </div>
//         </div>
//       </div>
//     </nav>
