...
//     documentTitle: "Home Stock - Item Table",
//     onAfterPrint: () => alert("Item table report successfully downloaded!"),
//     onBeforeGetContent: () => new Promise((resolve) => setTimeout(resolve, 500)), // Add a delay
//   });

//   // Generate and Download PDF using jsPDF
//   const handleDownloadPDF = () => {
//     const doc = new jsPDF();
//     doc.text("Item Table Report", 14, 15);

//     const tableColumn = ["Name", "Quantity", "Category", "Important Level", "Expiry Date"];
//     const tableRows = [];
...
//     doc.save("Item_Table_Report.pdf");
//   };
