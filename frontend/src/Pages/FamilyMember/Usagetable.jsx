...
// // CHANGE: Using the correct URL for fetching usages
...
//       // CRITICAL FIX: The response structure was likely misunderstood
//       // Let's directly look at the data without assuming a nested structure
//       const allData = Array.isArray(response.data) ? response.data : 
//                      (response.data.users || response.data.gshoppers || []);
      
//       // Filter items that have a usagedate to consider them as "usage" entries
//       const filteredUsages = allData.filter(item => 
//         item.usagedate && item.usagedate.toString() !== "Invalid Date"
//       );
      
//       console.log("Filtered usage data:", filteredUsages); // Debug log
...
//       if (data && data.users) {
//         // CHANGE: Filter items with usagedate first, then apply search filter
//         const usageItems = data.users.filter(item => 
//           item.usagedate && item.usagedate.toString() !== "Invalid Date"
//         );
        
//         const filteredUsages = usageItems.filter((usage) =>
...
//                       usages.map((usage, i) => (
//                         <tr key={i}>
//                           <td className="px-6 py-4 text-center">{usage.name}</td>
//                           <td className="px-6 py-4 text-center">{usage.qty}</td>
//                           <td className="px-6 py-4 text-center">{usage.category}</td>
//                           <td className="px-6 py-4 text-center">{formatDate(usage.usagedate)}</td>
//                           <td className="px-6 py-4 text-center">{usage.notes}</td>
//                         </tr>
//                       ))}
//                   </tbody>
//                 </table>
